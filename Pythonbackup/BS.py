...
factoryTime = 20     #Soundfile seconds factory
natureTime = 20      #Soundfile seconds nature
...
try:
	while True:
		...
		if currentState == 0:
			pygame.mixer.music.load("/home/pi/Downloads/sounds/factory.mp3")
		...
		if currentState == 2:
			pygame.mixer.music.load("/home/pi/Downloads/sounds/nature.mp3")
			pygame.mixer.music.play()
